...
python3 -m pip install -U pyobjc-core -t macOS/Myriagon.app/Contents/Resources/app_packages/
python3 -m pip install -U pyobjc-framework-CFNetwork -t macOS/Myriagon.app/Contents/Resources/app_packages/
